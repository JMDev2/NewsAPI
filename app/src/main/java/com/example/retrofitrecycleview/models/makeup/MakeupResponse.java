...
package com.example.retrofitrecycleview.models.makeup;
...
public class MakeupResponse {
     ...
     * @param updatedAt
     */
    public MakeupResponse(Integer id, String brand, String name, String price, String priceSign, String currency, String imageLink, String productLink, String websiteLink, String description, String rating, String category, String productType, List<String> tagList, String createdAt, String updatedAt, String productApiUrl, String apiFeaturedImage, List<ProductColor> productColors) {
        super();
        this.id = id;
        this.brand = brand;
        this.name = name;

...
public class Current {
     ...
     * @param uvIndex
     */
    public Current(String observationTime, Integer temperature, Integer weatherCode, List<String> weatherIcons, List<String> weatherDescriptions, Integer windSpeed, Integer windDegree, String windDir, Integer pressure, Integer precip, Integer humidity, Integer cloudcover, Integer feelslike, Integer uvIndex, Integer visibility, String isDay) {
        super();
